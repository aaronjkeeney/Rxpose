...
``` r
test_join <- stringdist_inner_join(all_weightlifting_results_for_join, df_weightlifters_with_doping_violations_reduced, by = "athlete_full_name", method = "jaccard", max_dist = 0.2)
view(test_join)
```

...
Below is the code that was run in SQLite within the markdown file. This filters for only weightlifting results from the correct years, and it extracts and casts the competition year and the weight lifted as more usable data types.
...
We need to use REGEX to extract the correct numeric portions of event_title for weight_class_kg. As mentioned above superheavyweights will be credited with the maximum weight. SQLITE DOES NOT SUPPORT REGEX, SO I MIGHT NEED TO EXPLORE BIGRQUERY OR ANOTHER OPTION.

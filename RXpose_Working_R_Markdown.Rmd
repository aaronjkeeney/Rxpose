...
```
This code conflates the weightclasses for the heaviest and second-heaviest categoies, but that will be sorted out with SQL. This resulting dataframe can be uploaded to our database.
